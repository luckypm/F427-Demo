...
#define MPU6000_SPI_REG_BAUD	    SPI_BaudRatePrescaler_64	// initial setup only SPI_BaudRatePrescaler_128 180M主频可用
#define MPU6000_SPI_RUN_BAUD	    SPI_BaudRatePrescaler_8	// 10.5 MHz

#define MPU6000_READ_BIT	    (0x01<<7)
#define MPU6000_WRITE_BIT	    (0x00<<7)

#define MPU6000_BYTES		    15
#define MPU6000_SLOT_SIZE	    ((MPU6000_BYTES+sizeof(int)-1) / sizeof(int) * sizeof(int))// 这里是18

#ifdef USE_QUATOS
    #define MPU6000_SLOTS	    80						    // 100Hz bandwidth
    #define MPU6000_DRATE_SLOTS	    (MPU6000_SLOTS * 100.0f * DIMU_INNER_DT * 2.0f) // variable 是40
#else
    #define MPU6000_SLOTS	    80						    // 100Hz bandwidth
