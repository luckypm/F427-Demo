...
#define DEFAULT_CTRL_PID_TYPE	    0		// 0 == parallel TILT/RATE PIDs, 1 == cascading TILT/RATE PIDs//0为并联，1为串联
...
#define DEFAULT_MOT_ARM		    975 // 0%
#define DEFAULT_MOT_MIN		    1000 // 电调只认[1000,2000]，1000占空比就是1%，2000就是100%
#define DEFAULT_MOT_START	    1125 // 12.5%
#define DEFAULT_MOT_MAX		    1950 // 95%
...
#define DEFAULT_COMM_BAUD2	    115200//230400
...
#define DEFAULT_COMM_STREAM_TYP1    0
#define DEFAULT_COMM_STREAM_TYP2    COMM_STREAM_TYPE_TELEMETRY
#define DEFAULT_COMM_STREAM_TYP3    0
#define DEFAULT_COMM_STREAM_TYP4    0
#define DEFAULT_COMM_STREAM_TYP5    0//COMM_STREAM_TYPE_MAVLINK    // CAN UART stream ID 1
#define DEFAULT_COMM_STREAM_TYP6    0                           // CAN UART stream ID 2
#define DEFAULT_COMM_STREAM_TYP7    0                           // CAN UART stream ID 3

#define DEFAULT_TELEMETRY_RATE	    1000		// loops between reports


#define DEFAULT_NAV_MAX_SPEED	    5.0f	// m/s
#define DEFAULT_NAV_MAX_DECENT	    1.5f	// m/s
#define DEFAULT_NAV_CEILING         0.0f	// m relative to home alt. Maximum altitude in alt/pos/mission/dvh modes//相对于home点的高度，是定高/定点/任务/DVH模式的最大高度
...
#define DEFAULT_IMU_FLIP            0                   // flip DIMU: 0 == none, 1 == around x axis, 2 == around y axis// 1为绕X轴翻转180度，即沿着pitch轴翻转，2为绕Y轴翻转180度，即沿着roll轴翻转
#define DEFAULT_IMU_ROT		    90		// degrees to rotate the IMU to align with the frame (applied after FLIP)逆时针为正，顺时针为负
#define DEFAULT_IMU_MAG_INCL	    -65.0   // 磁倾角
#define DEFAULT_IMU_MAG_DECL	    0.0     // 磁偏角
