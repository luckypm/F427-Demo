...
//#define DEBUG_TASK_INFO
//#define DEBUG_GET_TASK_STATUS
//#define DEBUG_GET_TASK_RUN_TIME

//#define USE_ANO_GS //连接匿名地面站
...
#define SUPERVISOR_READY_PORT	GPIOB//GPIOA
#define SUPERVISOR_READY_PIN	GPIO_Pin_11//GPIO_Pin_8
...
//427上的MPU6000使用的是SPI1，但SPI_SPI1_DMA_TX数据流3与SDIO的DMA数据流冲突了，故这里需改成stream5
//每个数据流有8个通道可选，但每次只能使用一个通道，不能同时使用两个，否则就冲突了
...
#define SPI_SPI2_SCK_PIN	    GPIO_Pin_10//GPIO_Pin_13 427上用的是PB10
#define SPI_SPI2_MISO_PIN	    GPIO_Pin_14
#define SPI_SPI2_MOSI_PIN	    GPIO_Pin_15
#define SPI_SPI2_SCK_SOURCE	    GPIO_PinSource10//GPIO_PinSource13
