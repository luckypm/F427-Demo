...
// Dilution of precision//¾«¶ÈÇ¿Èõ¶È£¬Í¨³£ÒëÎªÏà¶ÔÎó²î
typedef struct {
    unsigned long iTOW;	    // ms GPS Millisecond Time of Week
    unsigned short gDOP;    // Geometric DOP//¼¸ºÎÐÎ×´¾«¶ÈÇ¿Èõ¶È ,ËùÒÔ: Gdop µÄÆ½·½ = Pdop µÄÆ½·½ + Tdop µÄÆ½·½¡£
    unsigned short pDOP;    // Position DOP//Î»ÖÃ¾«¶ÈÇ¿Èõ¶È£¬ÎªÎ³¶È¡¢¾­¶ÈºÍ¸ß³ÌµÈÎó²îÆ½·½ºÍµÄ¿ª¸ùºÅÖµ
    unsigned short tDOP;    // Time DOP//Ê±¼ä¾«¶ÈÇ¿Èõ¶È£»Îª½ÓÊÕÒÇÄÚÊ±±íÆ«ÒÆÎó²îÖµ¡£
    unsigned short vDOP;    // Vertical DOP//´¹Ö±£¨¼´¸ß³Ì£©×ø±ê¾«¶ÈÇ¿Èõ¶È£»Îª¸ß³ÌµÄÎó²îÖµ¡£
    unsigned short hDOP;    // Horizontal DOP//Ë®Æ½£¨¼´¶þÎ¬£©×ø±ê¾«¶ÈÇ¿Èõ¶È£»ÎªÎ³¶ÈºÍ¾­¶ÈµÈÎó²îÆ½·½ºÍµÄ¿ª¸ùºÅÖµ¡£
