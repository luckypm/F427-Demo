...
#define DIMU_TASK_PRIORITY	 11

#define DIMU_OUTER_PERIOD   5000			    // us (200 Hz)
#define DIMU_INNER_PERIOD   2500			    // us (400 Hz)
#define DIMU_OUTER_DT	    ((float)DIMU_OUTER_PERIOD / 1e6f)//同下，即5e-3s外部周期
#define DIMU_INNER_DT	    ((float)DIMU_INNER_PERIOD / 1e6f)//us转换成s，即2.5e-3s内部周期
