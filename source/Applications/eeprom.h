...
#define DIMU_EEPROM_SIZE	    0x4000// FM25V01总容量就只有16K
#define DIMU_EEPROM_BLOCK_SIZE	0x40


#define EEPROM_WREN		    0x06//0b0110
#define EEPROM_WRDI		    0x04//0b0100
#define EEPROM_RDSR		    0x05//0b0101
#define EEPROM_WRSR		    0x01//0b0001
#define EEPROM_READ		    0x03//0b0011
#define EEPROM_FSTRD		0x0B
#define EEPROM_WRITE		0x02//0b0010
